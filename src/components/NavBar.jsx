		...
		<div className='navbar bg-base-300'>
			...
			<div className='flex-none gap-2'>
				...
				<label className='swap swap-rotate'>
					...
					<input type='checkbox' className='theme-controller' checked={theme === 'light'} onChange={handleThemeToggle} />
				...
				{user && (
					<div className='dropdown dropdown-end mx-5'>
						...
						<ul tabIndex={0} className='menu menu-sm dropdown-content bg-base-300 rounded-box z-[1] mt-3 w-52 p-2 shadow'>
							<li>
								<a className='no-underline pointer-events-none'>
									Welcome, <span className='font-bold'>{user.firstName.toUpperCase()}</span>
								</a>
							</li>
							<li>
